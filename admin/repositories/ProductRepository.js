import Repository, { Local, baseUrl, serializeQuery } from "./Repository";
...
class ProductRepository {
  ...
  async getProductCategories() {
    const reponse = await Repository.get(`${baseUrl}/api/product-categories`)
      .then((response) => {
        return response.data;
      })
      .catch((error) => ({ error: JSON.stringify(error) }));
  ...
  async getProductsById(payload) {
    const reponse = await Local.get(`${baseUrl}/api/product/getById/${payload}`)
  ...
  async getProductsByBrands(payload) {
    ...
    const reponse = await Repository.get(`${baseUrl}/api/brands?${query}`)
      .then((response) => {
        return response.data;
      })
      .catch((error) => ({ error: JSON.stringify(error) }));
  ...
  async getProductsByBrands(payload) {
    ...
    const reponse = await Repository.get(`${baseUrl}/api/sbrands?${query}`)
      .then((response) => {
        return response.data;
      })
      .catch((error) => ({ error: JSON.stringify(error) }));
  ...
  async editProduct(payload) {
    ...
    const reponse = await Local.put(`${baseProductUrl}/${endPoint}`, payload)
      .then((response) => {
        if (response.status === 200) {
          return { status: "Success", message: response.data.message };
        } else {
  ...
  async statusChange(payload) {
    ...
    const reponse = await Local.patch(`${baseProductUrl}/${endPoint}`, payload)
      .then((response) => {
        if (response.status === 200) {
          return { status: "Success", message: response.data.message };
        } else {
