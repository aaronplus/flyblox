      ...
      <div className='navigation--list'>
        ...
        >
          <div className='ps-panel--wrapper'>
            ...
            <div className='ps-panel__content'>
              <PanelMenu onClose={this.handleDrawerClose} />
            </div>
          </div>
        </Drawer>
        <Drawer
        ...
        >
          <div className='ps-panel--wrapper'>
            ...
            <div className='ps-panel__content'>
              <PanelCartMobile onClose={this.handleDrawerClose} />
            </div>
          </div>
        </Drawer>
        <Drawer
        ...
        >
          <div className='ps-panel--wrapper'>
            ...
            <div className='ps-panel__content'>
              <PanelSearch onClose={this.handleDrawerClose} />
            </div>
          </div>
        </Drawer>
        <Drawer
        ...
        >
          <div className='ps-panel--wrapper'>
            ...
            <div className='ps-panel__content'>
              <PanelCategories onClose={this.handleDrawerClose} />
            </div>
          </div>
        </Drawer>
